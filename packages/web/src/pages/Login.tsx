...
export function Login() {
  ...
  useEffect(() => {
    if (oauthError === "oauth_failed") {
      setError("OAuth login failed. Please try again or use another method.");
    }
  }, [oauthError]);
    ...
    <div className="flex justify-center py-8">
      <Card className="w-full max-w-md">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <span className="text-sm text-neutral-500">or sign in with email</span>
          <hr className="flex-1 border-neutral-200" />
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 mb-6">
          ...
          <div className="text-right">
            <Link
              ...
              className="text-sm text-primary-800 hover:text-primary-700 underline"
            >
        ...
        <div className="text-center mb-4">
          <Link
            ...
            className="text-base text-primary-800 hover:text-primary-700 underline"
          >
