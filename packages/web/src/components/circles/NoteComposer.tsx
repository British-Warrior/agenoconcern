  ...
  return (
    <div className="rounded-[var(--radius-lg)] border border-neutral-200 bg-white p-4">
      ...
      <textarea
        ...
        className="w-full text-sm text-neutral-800 placeholder-neutral-400 border-none outline-none resize-none bg-transparent leading-relaxed disabled:opacity-50"
      />
